    ...
    try {
      ...
      if (newSessionId) {
        updateBoard((prev) => ({
          ...prev,
          tasks: prev.tasks.map(
            (t) => t.id === task.id ? { ...t, columnId: "in_progress", claimedSessionId: newSessionId, assignee: "ai" } : t
          )
        }));
      }
    } catch (err) {
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: "10px", minWidth: 0 }, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: "11px", color: "var(--dsw-alias-label-secondary, #a0a0a8)" }, children: activeTimerTask ? `\u4EBA\u7C7B\u4E13\u6CE8\u8FDB\u884C\u4E2D` : "\u4EBA\u7C7B\u4EFB\u52A1\u70B9\u51FB [\u23F1] \u8F7D\u5165\u9650\u65F6\u8BA1\u65F6\uFF1BAI \u4EFB\u52A1\u70B9\u51FB [\u{1F680} \u6D3E\u53D1\u4F1A\u8BDD] \u76F4\u63A5\u5F00\u4F1A\u8BDD\u6267\u884C" }),
              ...
              return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                "div",
                {
                  ...
                  children: [
                    ...
                    task.claimedSessionId && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: "4px", fontSize: "11px" }, children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { color: "var(--dsw-alias-label-tertiary)" }, children: "\u6267\u884C\u4F1A\u8BDD:" }),
                        ...
                        "button",
                        {
                          ...
                          children: [
                            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [
                              "\u{1F4AC} ",
                              task.claimedSessionId.slice(0, 10),
                              "..."
                            ] }),
...
function CanvasViewBridge({ sessionId, useWorkspaces, inputActions, cordisCtx }) {
  ...
  const dispatchAndAutoSend = (text) => {
    ...
    setTimeout(() => {
      if (inputActions && typeof inputActions.submit === "function") {
        ...
        const sendBtn = document.querySelector('button[class*="send"], button[aria-label*="Send"], button[aria-label*="\u53D1\u9001"]');
